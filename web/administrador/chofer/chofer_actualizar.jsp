<%-- 
    Document   : chofer_actualizar
    Created on : 23-jul-2017, 15:44:43
    Author     : Pablo
--%>
...
<%
    ...
    conexion.setSQL("select * from choferes where chofer_id='"+id+"'");
    ...
    <body>
        <main>
            ...
            <div class="row container">
                <h5>Actualizar datos del Chofer:</h5>
                <form class="col s12" method="post" action="../../ServletChofer?accion=actualizar">
                    <div class="row">
                                ...
                                <div class="class card-content">
                                    <div class="row">			
                                        <div class="input-field col s12">
                                            ...
                                            %>
                                                <input id="icon_prefix" type="text" class="validate" value="<% out.println(""+id); %>" name="chofer_id">
                                            <% }else{ %>
                                            <input id="icon_prefix" type="text" class="validate" value="<% out.println(""+id); %>" name="chofer_id" readonly>
                                            <% } %>    
                                    ...
                                    <div class="row">			
                                        <div class="input-field col s12">
                                            <i class="material-icons prefix">perm_identity</i>
                                            <input id="icon_prefix" type="text" class="validate" value="<% out.println(""+conexion.getRs().getString("nombre_chofer")); %>" name="nombre_chofer">
                    ...
                    <button class="btn waves-effect waves-light" type="submit" name="action">Actualizar Chofer
