<%-- 
    ...
    Created on : 24-07-2017, 15:12:33
    Author     : Galmier
--%>
            ...
            <div class="nav-wrapper">    
                <nav class="teal">
                    ...
                    <ul id="slide-out" class="side-nav">
                        ...
                        <li><a href="usuario_index.jsp"><i class="material-icons">perm_identity</i>Modulo Usuarios</a></li>
                ...
                <table class="responsive-table bordered highlight">
                    ...
                    <tbody>
                         <% Conexion conexion=new Conexion();
                            conexion.setSQL("SELECT usuarios.usuario_id,usuarios.nombre_usuario,usuarios.ap_paterno,usuarios.ap_materno,usuarios.username,empresas.nombre_empresa,privilegios.tipo_privilegio from usuarios,empresas,privilegios WHERE  usuarios.empresa_id=empresas.empresa_id and usuarios.privilegio_id=privilegios.privilegio_id and estado='activo'");
